				...
				if (Character.isDigit(temp.charAt(0)))
				{
					...
					switch (tempTest){
						...
						case "approach": CommandInterface approachCom = new Approach(temp);
							...
							temp = "";
							break;
						case "pass": CommandInterface passCom = new Pass(temp);
							storeTokens[counter] = passCom;
							counter++;
							temp = "";
							break;
						case "fail": CommandInterface failCom = new Fail(temp);
							storeTokens[counter] = failCom;
							counter++;
							temp = "";
							break;
						default:
