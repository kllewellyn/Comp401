...
public class Assignment11 {
	...
	public static void main(String[] args) {
		...
		OEFrame editor = ObjectEditor.edit(commands);
		editor.setSize(200, 200);
		editor.setVisible(true);
		commands.setCommand("move Arthur 50 50 ");
		ThreadSupport.sleep(2000);
		commands.setCommand("repeat 5 { move Arthur 0 20 } ");
		ThreadSupport.sleep(2000);
